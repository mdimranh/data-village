...
class CustomUserManager(BaseUserManager):
    def _create_user(
        self, email, phone, password, gender, is_staff, is_superuser, **extra_fields
    ):
        now = timezone.now()
    ...
    def create_user(
        self, email, phone=None, password=None, gender="male", **extra_fields
    ):
        return self._create_user(
            email, phone, password, gender, False, False, **extra_fields
        )

    def create_superuser(self, email, phone, password, gender="male", **extra_fields):
        return self._create_user(
            email, phone, password, gender, True, True, **extra_fields
        )
